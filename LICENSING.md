...
Except for third-party material and files carrying a separate license or copyright notice, the original software in rtailscale authored by Jacob Magar or Dinglebear AI is licensed under the GNU Affero General Public License version 3.0 only (SPDX: AGPL-3.0-only). The complete terms are in LICENSE.
